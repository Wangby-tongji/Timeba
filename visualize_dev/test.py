...
def main():
    ...
    if args.split == "val":
        ...
        from argoverse.evaluation.eval_forecasting2 import (
            compute_forecasting_metrics,
        )
        # Max #guesses (K): 6
        _ = compute_forecasting_metrics(preds, gts, cities, 6, 50, 2)
        # Max #guesses (K): 1
        _ = compute_forecasting_metrics(preds, gts, cities, 1, 50, 2)
    else:
